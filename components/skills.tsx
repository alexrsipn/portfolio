    ...
    >
      <div className="m-8">
        ...
        <div className="grid grid-cols-2">
          <div className="flex flex-wrap justify-center items-center">
            <div className="flex relative py-4 sm:items-center md:w-2/3 mx-auto">
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                <div className="flex-shrink-0 w-12 h-12 bg-cornflowerBlue-400 bg-opacity-80 hover:bg-cornflowerBlue-500 hover:bg-opacity-100 text-white rounded-full inline-flex items-center justify-center">
                  <svg
          ...
          <div className="flex flex-wrap justify-center items-center">
            <div className="flex relative py-4 sm:items-center md:w-2/3 mx-auto">
              <div className="h-full w-6 absolute right-0 flex items-center justify-center">
                <div className="h-full w-1 bg-gainsboro-500 pointer-events-none"></div>
              </div>
